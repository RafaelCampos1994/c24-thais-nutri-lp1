        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {testimonials.map((t, idx) => (
            <Reveal key={idx} delay={idx * 0.1}>
              <div className="bg-white p-8 rounded-3xl shadow-lg shadow-brand-100/50 border border-brand-100 relative h-full flex flex-col transform hover:-translate-y-2 transition duration-300">
                <Quote className="w-12 h-12 text-gold-100 absolute top-6 right-6" />
                
                <div className="flex items-center gap-1 mb-6 text-gold-400">
